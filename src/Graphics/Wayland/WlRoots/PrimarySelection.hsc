...
foreign import ccall safe "wlr_gtk_primary_selection_device_manager_create" c_create :: Ptr DisplayServer -> IO (Ptr PrimarySelectionManager)
...
foreign import ccall safe "wlr_gtk_primary_selection_device_manager_destroy" c_destroy :: Ptr PrimarySelectionManager -> IO ()
...
getPrimaryGlobal = #{peek struct wlr_gtk_primary_selection_device_manager, global} . unPSM
